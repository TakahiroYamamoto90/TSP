...
$all_results | export-csv -Path "$OUTPUT_CSV_FOLDER_PATH\課題3-3_random_all_$now_string.csv" -Encoding UTF8 -NoTypeInformation
...
$best_results | export-csv -Path "$OUTPUT_CSV_FOLDER_PATH\課題3-3_random_best_$now_string.csv" -Encoding UTF8 -NoTypeInformation